...
void OpticalFlowMultiLevel(
    ...
    for (int i = 0; i < pyramids; i++) {
        Mat re_img1,re_img2;
        resize(img1,re_img1,Size(img1.cols*scales[i],img1.rows*scales[i]));
        resize(img1,re_img1,Size(img2.cols*scales[i],img2.rows*scales[i]));
        pyr1.push_back(re_img1);
        pyr2.push_back(re_img2);
    }
    // TODO END YOUR CODE HERE
